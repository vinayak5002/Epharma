 ...
 */
	...
	public MedicineDTO(Integer medicineId, String medicineName, String manufacturer, Integer price, String category,
			LocalDate manufacturingDate, LocalDate expiryDate, Integer discountPercent, Integer quantity) {
		super();
